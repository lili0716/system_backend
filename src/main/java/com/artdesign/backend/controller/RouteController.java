...
public class RouteController {
    ...
    public Map<String, Object> getRoutes() {
        ...
        // Only leaders/admin should see this ideally, but handled by frontend
        // visibility often.
        // Backend role check: R_SUPER, R_ADMIN. For dynamic leaders, we might just
        // expose to all and let frontend hide empty lists?
        // Or if we want strict role control: R_SUPER, R_ADMIN.
        // User request says: "display form approval function based on whether user is
        // leader".
        // The current hardcoded mock uses static roles. Let's add R_USER too, so
        // everyone can access (and see empty list if not leader),
        // OR better, keep it broad here and let the specific permissions logic handle
        // visibility if we had it.
        ...
        recordRoute.put("path", "upload");
        recordRoute.put("name", "AttendanceUpload");
        recordRoute.put("component", "/attendance/upload");

        Map<String, Object> recordMeta = new HashMap<>();
        recordMeta.put("title", "上传考勤");
